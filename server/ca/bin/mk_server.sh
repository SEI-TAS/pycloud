...
$srcdir/_mk_server_info.sh $HOST > $tmp

echo "Generating private key"
$srcdir/_mk_key.sh $HOST.server.key.pem

echo "Generating certificate"
$srcdir/_mk_cert.sh $HOST $tmp $HOST.server.key.pem $CA_CERT $CA_CERT_KEY $HOST.server.pem
